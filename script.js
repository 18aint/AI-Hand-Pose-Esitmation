...
function testSupport(supportedDevices) {
    ...
    if (!isSupported) {
        alert(`This software, running on ${detectedDevice.client.name}/${detectedDevice.os.name}, ` +
...
new controls
    ...
    .add([
    new controls.StaticText({ title: 'AI Hand Pose Estimation' }),
    fpsControl,
    new controls.Toggle({ title: 'Inverted Camera', field: 'selfieMode' }),
